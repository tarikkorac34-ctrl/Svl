...
// Helper to make a markdown clickable stadium link
function formatStadiumLink(venueName) {
  return `[SVL Stadium Hub (${venueName})](${STADIUM_HUB_LINK})`;
}
...
// ============================================================
// SCHEDULER (NOTIFIES 5 HOURS / 300 MINS BEFORE KICK OFF)
// ============================================================
