...
async function cmdRequestSign(interaction) {
  ...
  if (existingPlayer && existingPlayer.team) {
    ...
    return interaction.editReply({
      content: `⚠️ This player is already signed to **${currentTeamName}**. Please submit a sign request again once the player has been released or is a Free Agent (F/A).`
    });
  }
