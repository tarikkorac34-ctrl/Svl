...
// Initialize Roblox Authentication & Fetch Initial XSRF Token
...
async function handleRankAccept(interaction) {
  ...
  // 1. Automatic Roblox Group Ranking (With X-CSRF Refresh)
  let robloxStatus = 'Not Configured';
  if (ROBLOX_GROUP_ID && ROBLOX_COOKIE) {
    try {
      // Re-initialize session to get a fresh X-CSRF token before ranking
