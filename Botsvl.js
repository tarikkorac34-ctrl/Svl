...
// ============================================================
// DYNAMIC CANVAS TABLE RENDERER (RELATIVE POSITIONS)
// ============================================================
async function generateStandingsImage(title, rows) {
  ...
  // Define proportions relative to actual canvas resolution
  ...
  // Scale fonts dynamically relative to canvas width
  ...
  // Columns defined by percentages from the left margin
  const colPOS  = cardMarginX + (cardWidth * 0.05);
  const colTEAM = cardMarginX + (cardWidth * 0.14);
  
  // Stats columns calculated from right edge inside card
