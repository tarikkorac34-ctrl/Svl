...
// ============================================================
// CANVAS TABLE RENDERER (LINUX & RAILWAY SAFE)
// ============================================================
async function generateStandingsImage(title, rows) {
  ...
  // Cross-platform font declarations
  const fontMain = 'bold 22px DejaVu Sans, Arial, sans-serif';
  const fontTitle = 'bold 36px DejaVu Sans, Arial, sans-serif';
  const fontHeader = 'bold 20px DejaVu Sans, Arial, sans-serif';
...
// --- /standings (PUBLIC - OPEN TO EVERYONE) ---
...
// --- /resettable (RESTRICTED TO STAFF/ADMIN) ---
...
// --- /requestsign, /requestrelease, /player, /cancelgame ---
